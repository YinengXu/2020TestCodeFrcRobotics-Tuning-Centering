...
public class DriveTrain extends SubsystemBase {
  ...
  public void setSpeed(double velos){
    left_velocity = velos;
  ...
  public void setVelocity(){
    m_pidController.setReference(-left_velocity+heading,ControlType.kDutyCycle);
    m_pidController2.setReference(right_velocity+heading,ControlType.kDutyCycle);
